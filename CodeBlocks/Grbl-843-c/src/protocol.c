...
/// 843 : verify limit axis A
	  case STATUS_BAD_NUMBER_DEGREE:
		printPgmString(PSTR("Bad degrees value [-360..360] \r\n"));
		break;
/// <--
      default:
...
/// 843 : 4 -> N_AXIS
 ...
 memcpy(print_position,sys.position,sizeof(sys.position));  ///print_position = sys.position
   ...
   //printString(","); printFloat(print_position[U_AXIS]/(settings.steps_per_mm[U_AXIS]*MM_PER_INCH));
   ...
   // printString(","); printFloat((print_position[U_AXIS]/settings.steps_per_mm[U_AXIS]-sys.coord_system[sys.coord_select][U_AXIS]-sys.coord_offset[U_AXIS])/MM_PER_INCH);
   ...
   //printString(","); printFloat(print_position[U_AXIS]/(settings.steps_per_mm[U_AXIS]));
/// 843 : TODO -> degree
   ...
   // printString(","); printFloat(print_position[U_AXIS]/settings.steps_per_mm[U_AXIS]-sys.coord_system[sys.coord_select][U_AXIS]-sys.coord_offset[U_AXIS]);
/// 843 : TODO -> degree
