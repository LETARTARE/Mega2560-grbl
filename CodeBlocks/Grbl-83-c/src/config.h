...
// SPINDLE_ENABLE_INVERT: Set to 0 for active high spindle enable or 1
// for active low enable.
#define SPINDLE_ENABLE_INVERT  1
///<---
...
///---> LETARTARE 16/04/2014
// SPINDLE_DIRECTION_INVERT: Set to 0 for active high spindle direction or 1
// for active low enable.
#define SPINDLE_DIRECTION_INVERT  1
///<---
...
///---> LETARTARE 16/04/2014
// COOLANT_FLOOD_INVERT: Set to 0 for active high flood enable or 1
// for active low enable.
#define COOLANT_FLOOD_INVERT  0
///<---
...
//---> LETARTARE 16/04/2014
// COOLANT_MIST_INVERT: Set to 0 for active high mist enable or 1
// for active low enable.
#define COOLANT_MIST_INVERT  0
#endif
