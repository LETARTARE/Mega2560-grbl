...
/// ==> LETARTARE 21-04-2014 axes X, Y, Z, A
#ifdef DEFAULTS_084x
  #define MICROSTEPS 2    // board TB6560
  // Grbl generic default settings. Should work across different machines.
  #define DEFAULT_X_STEPS_PER_MM (50*MICROSTEPS)
  #define DEFAULT_Y_STEPS_PER_MM (50*MICROSTEPS)
  #define DEFAULT_Z_STEPS_PER_MM (50*MICROSTEPS)
  #define DEFAULT_A_STEPS_PER_MM (50*MICROSTEPS) // + axis A
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_MM_PER_ARC_SEGMENT 0.1
  #define DEFAULT_RAPID_FEEDRATE 500.0 // mm/min
  #define DEFAULT_FEEDRATE 250.0
